    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InvoiceGroupLineId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerInvoiceGroupLines_CustomerInvoices_CustomerInvoice_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ItemGroupItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ItemGroup_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Item_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GroupItemLineId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CustomerInvoiceGroupLine_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Item_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Quantity = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    Price = table.Column<decimal>(type: "decimal(10,2)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerInvoiceGroupItemLines_CustomerInvoiceGroupLines_CustomerInvoiceGroupLine_id",
